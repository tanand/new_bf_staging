...
Partial Public Class [Default]
    ...
    Private scope_value As String = "TL"
    ...
    Public Sub get_auth_code(ByVal api_key As String, ByVal scope_value As String)
        ...
        HttpContext.Current.Response.Redirect("https://beta-api.att.com/oauth/authorize?scope=TL&client_id=" & api_key & "&redirect_uri=http://wincode-api-att.com/VBDotNet/dc/DeviceLocation/Default.aspx")
    ...
    Protected Sub lnkbtnAccessCode_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkbtnAccessCode.Click
        ...
        End Try
    End Sub
    ' User invoked Event for getting terminal location 
    ' Invoke AT&T Device Information api through http web request along with access token 
    ' and get the terminal location from destination msisdn
    Protected Sub btnGetDeviceLocation_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnGetDeviceLocation.Click
        Try
            ...
            Dim objRequest As HttpWebRequest = DirectCast(System.Net.WebRequest.Create("https://beta-api.att.com/1/devices/tel:" & strReq.ToString() & "/location?access_token=" & access_tkn.ToString()), HttpWebRequest)
