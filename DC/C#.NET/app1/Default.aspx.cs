...
public partial class Default : System.Web.UI.Page
{
    ...
    public void get_auth_code(string api_key, string scope_value)
    {
        ...
        HttpContext.Current.Response.Redirect("https://beta-api.att.com/oauth/authorize?scope=" + scope_value + "&client_id=" + api_key + "&redirect_uri=http://wincode-api-att.com/dotnet/dc/DeviceInformation/Default.aspx");
     ...
     * Invoke AT&T Get Device Information api through http web request along with access token 
     * and Displays the information of given msisdn 
     */
    ...
    protected void btnGetDeviceInfo_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            HttpWebRequest objRequest = (HttpWebRequest)System.Net.WebRequest.Create("https://beta-api.att.com/1/devices/tel:" + strReq.ToString() + "/info?access_token=" + access_tkn.ToString());
