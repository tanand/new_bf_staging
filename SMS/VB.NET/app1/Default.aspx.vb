...
Partial Public Class [Default]
    ...
    Public Sub get_auth_code(ByVal api_key As String, ByVal scope_value As String)
        ...
        HttpContext.Current.Response.Redirect("https://beta-api.att.com/oauth/authorize?scope=SMS&client_id=" & api_key & "&redirect_uri=http://wincode-api-att.com/VBDotNet/sms/ReceiveSMS/Default.aspx")
    ...
    Protected Sub lnkbtnAccessCode_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkbtnAccessCode.Click
        ...
        End Try
    End Sub
    ' User invoked Event for receiving sms
    ' Invoke AT&T receive sms api through http web request along with access token 
    ' and get the count of receive message from destination msisdn
    Protected Sub btnReceiveSMS_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnReceiveSMS.Click
        Try

            Dim access_tkn As String = txtAccessToken.Text.ToString()
            Dim strResult As [String]

            Dim objResponse As HttpWebResponse
            Dim objRequest As HttpWebRequest = DirectCast(System.Net.WebRequest.Create("https://beta-api.att.com/1/messages/inbox/sms?access_token=" & access_tkn.ToString() & "&registrationID=" & short_code), HttpWebRequest)
