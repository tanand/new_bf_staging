...
public partial class Default : System.Web.UI.Page
{
    ...
    public void get_auth_code(string api_key, string scope_value)
    {
        ...
        HttpContext.Current.Response.Redirect("https://beta-api.att.com/oauth/authorize?scope=SMS&client_id=" + api_key + "&redirect_uri=http://wincode-api-att.com/dotnet/sms/ReceiveSMS/Default.aspx");
  ...
  */
     ...
     * Invoke AT&T Receiving sms api through http web request along with access token 
     * and get the sms message of given msisdn 
     */
    protected void btnReceiveSMS_Click(object sender, EventArgs e)
    {
        try
        {
           
            string access_tkn = txtAccessToken.Text.ToString();
            String strResult;

            HttpWebResponse objResponse;

            // Form Http Web Request
            HttpWebRequest objRequest = (HttpWebRequest)System.Net.WebRequest.Create("https://beta-api.att.com/1/messages/inbox/sms?access_token=" + access_tkn.ToString() + "&registrationID=" + short_code);
